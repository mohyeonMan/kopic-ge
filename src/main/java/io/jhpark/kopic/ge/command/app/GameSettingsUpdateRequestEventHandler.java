...
@Slf4j
@Component
public class GameSettingsUpdateRequestEventHandler extends AbstractRoomEventHandler {

	public GameSettingsUpdateRequestEventHandler(RoomService roomService) {
		super(roomService);
	}

	@Override
	public InboundRoomEventType supports() {
		return InboundRoomEventType.GAME_SETTINGS_UPDATE_REQUEST;
	}

	@Override
	public EngineAck handle(RoomEventContext context) {
		log.debug("game settings update handler skeleton invoked. roomId={}, userId={}",
